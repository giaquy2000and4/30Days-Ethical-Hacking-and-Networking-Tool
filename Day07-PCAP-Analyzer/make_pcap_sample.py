...
# DNS Query
dns_pkt = Ether()/IP(src="192.168.0.7", dst="8.8.8.8")/UDP(sport=12345, dport=53)/DNS(rd=1, qd=DNSQR(qname="Insta-Hunter-Img.local"))
packets.append(dns_pkt)

# HTTP GET
http_get = (
    "GET / HTTP/1.1\r\n"
    "Host: Insta-Hunter-Img.local\r\n"
...
multipart = (
    ...
    "------WebKitFormBoundary\r\n"
    "Content-Disposition: form-data; name=\"file\"; filename=\"Insta-Hunter-Img.txt\"\r\n"
